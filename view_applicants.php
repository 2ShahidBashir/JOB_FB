...
// Get applicants
$applicants_stmt = $conn->prepare("SELECT a.id, a.status, a.cover_letter, a.created_at, a.resume_path,
                                  u.name, u.email
                                  FROM applications a
            ...
            <div class="applicant-card">
                <div class="applicant-header">
                    <div class="applicant-info">
                        ...
                        <?php if (!empty($applicant['resume_path']) && file_exists($applicant['resume_path'])): ?>
                ...
                <?php if ($applicant['status'] == 'pending'): ?>
                    <div class="action-buttons mt-3">
                        <form method="POST" style="display: inline;">
                            ...
                            <button type="submit" name="action" value="select" class="btn btn-success btn-sm">
