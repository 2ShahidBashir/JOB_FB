        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 hero-image">
                    <img src="https://img.freepik.com/free-vector/hand-drawn-flat-design-stack-books-illustration_23-2149330602.jpg" alt="Career Growth" class="img-fluid rounded-circle">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="mailto:nobisuke7006@gmail.com" class="text-decoration-none text-white">
                                <i class="fas fa-envelope me-2"></i>nobisuke7006@gmail.com
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="tel:+919622290331" class="text-decoration-none text-white">
                                <i class="fas fa-phone me-2"></i>+91 9622290331
                            </a>
                        </li>
                        <li class="mb-2 text-white">
                            <i class="fas fa-map-marker-alt me-2"></i>Pulwama, Kashmir, 192301
                        </li>
                    </ul>
                </div>
            </div>
